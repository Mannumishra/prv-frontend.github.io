...
const Admincontact = () => {
  ...
  const getApiData = async () => {
    try {
      ...
      const res = await axios.get("https://prv-backend-github-io.onrender.com/api/contact", {
        headers: {
  ...
  const deleteContact = async (_id) => {
    try {
      const token = localStorage.getItem('token');
      const res = await axios.delete("https://prv-backend-github-io.onrender.com/api/contact/" + _id, {
        headers: {
          Authorization: `Bearer ${token}`
        }
      });
